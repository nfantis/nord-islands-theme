...
## Storage
## Strings
ZSH_HIGHLIGHT_STYLES[command-substitution-quoted]='fg=#D08770'
ZSH_HIGHLIGHT_STYLES[command-substitution-delimiter-quoted]='fg=#D08770'
...
ZSH_HIGHLIGHT_STYLES[rc-quote]='fg=#D08770'
## Variables
